...
clear;clear;clear
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo -e "\033[96;1m                        HENDRA STORE             \033[0m"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
sleep 3
clear
...
clear
rm -f /usr/bin/user
username=$(curl https://raw.githubusercontent.com/Sulastriii/mix/main/izin-ip-sandz | grep $MYIP | awk '{print $2}')
echo "$username" >/usr/bin/user
expx=$(curl https://raw.githubusercontent.com/Sulastriii/mix/main/izin-ip-sandz | grep $MYIP | awk '{print $3}')
echo "$expx" >/usr/bin/e
...
Exp1=$(curl https://raw.githubusercontent.com/Sulastriii/mix/main/izin-ip-sandz | grep $MYIP | awk '{print $4}')
if [[ $today < $Exp1 ]]; then
sts="${Info}"
else
sts="${Error}"
...
REPO2="https://raw.githubusercontent.com/Pelekpak/ki/main/"
start=$(date +%s)
secs_to_human() {
...
clear
restart_system() {
USRSC=$(wget -qO- https://raw.githubusercontent.com/Sulastriii/mix/main/izin-ip-sandz | grep $ipsaya | awk '{print $2}')
EXPSC=$(wget -qO- https://raw.githubusercontent.com/Sulastriii/mix/main/izin-ip-sandz | grep $ipsaya | awk '{print $3}')
...
wget raw.githubusercontent.com/Sulastriii/mix/main/Fls/limit.sh && chmod +x limit.sh && ./limit.sh
cd
...
wget -q -O /usr/sbin/dropbear "${REPO2}limit/ftvpn"
